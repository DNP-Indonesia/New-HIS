...
<?php foreach ($section as $u) { ?>
    ...
    <div class="modal fade" id="edit<?php echo $u->id_section ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-l" role="document">
            <div class="modal-content">
                ...
                <form action="<?php echo site_url() . 'Master/c_karyawan/do_edit_section' ?>" method="post">
    ...
    <!-- HAPUS Modal-->
    <div class="modal fade" id="hapus<?php echo $u->id_section ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
