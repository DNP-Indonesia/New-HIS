						...
						<tr>
							...
							<td style="width:10%;">
								<a href="#" class="btn btn-warning btn-icon-split btn-sm" data-toggle="modal"
									data-target="#edit<?php echo $u->id_jabatan ?>">
...
<!-- TAMBAH USER Modal-->
<div class="modal fade" id="ModalTbhjabatan" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
	aria-hidden="true">
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			...
			<form action="<?php echo site_url() . 'Master/action_his/do_tbh_jabatan'; ?>" method="post">
				<div class="modal-body">
					<div class="form-row">
						<div class="col-md-12 mb-3">
							<label for="exampleInputEmail1"><b>Nama Jabatan</b></label>
							<input type="text" class="form-control" id="exampleInputEmail1" name="nama_jabatan"
								required>
...
<!-- EDIT USER Modal-->
<div class="modal fade" id="edit<?php echo $u->id_jabatan ?>" tabindex="-1" role="dialog"
	...
	<div class="modal-dialog modal-dialog-centered modal-xl" role="document">
		<div class="modal-content">
			...
			<form action="<?php echo site_url() . 'Master/action_his/do_edit_jabatan' ?>" method="post">
				...
				<div class="modal-body">
					<div class="form-row">
						<div class="col-md-12 mb-3">
							<label for="exampleInputEmail1"><b>Nama Jabatan</b></label>
							<input type="text" class="form-control" id="exampleInputEmail1" name="nama_jabatan"
								value="<?php echo $u->nama_jabatan; ?>" required>
							<small id="emailHelp" class="form-text text-muted">Input nama Jabatan disini</small>
						</div>
					</div>
				</div>
