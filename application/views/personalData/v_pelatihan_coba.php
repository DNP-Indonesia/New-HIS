                                                        ...
                                                        <form action="<?php echo site_url("action_his/do_edit_karyawan_temp/" . $u->nik_temp) ?>" method="post">
                                                            <div class="modal-body">
                                                                <div class="form-row">
                                                                    ...
                                                                    <!-- <div class="col-md-6 mb-3">
                                                                            <label><b>NIK</b></label>
                                                                            <input type="text" class="form-control" name="nik_temp" value="<?php echo $u->nik_temp ?>" required>
                                                                ...
                                                                <div class="form-row">
                                                                    ...
                                                                    <div class="col-md-6 mb-3">
                                                                        ...
                                                                        <select class="form-control" id="exampleFormControlSelect1" name="id_section" required>
                                                                            ...
                                                                            ?>
                                                                                <option value="<?php echo $sec->d_section; ?>" <?php echo $sel; ?>><?php echo $sec->nama_section; ?></option>
                                                                            <?php } ?>
                                                                        </select>
