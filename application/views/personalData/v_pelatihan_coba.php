                                ...
                                <table class="table table-bordered" id='dataTable' width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                    ...
                                                    <div class="btn-group dropleft">
                                                        ...
                                                        <div class="dropdown-menu bg-gradient-dark" aria-labelledby="dropdownMenuButton">
                                                            ...
                                                            <p class="dropdown-item">
                                                                <a href="" class="btn btn-primary btn-icon-split btn-sm" data-toggle="modal" data-target="#ModalAngkat<?php echo $u->nik_training ?>">
                                                                    <span class="icon text-white-50">
                                                            ...
                                                            <p class="dropdown-item">
                                                                <a href="" class="btn btn-warning btn-icon-split btn-sm" data-toggle="modal" data-target="#ModalEditKar<?php echo $u->nik_training ?>">
                                                                    <span class="icon text-white-50">
                                                                        <i class="fas fa-edit"></i>
                                                                    </span>
                                            ...
                                            <div class="modal fade" id="ModalAngkat<?php echo $u->nik_training ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h3 class="modal-title" id="exampleModalLabel">Angkat Menjadi Karyawan <?php echo $u->nama ?></h3>
                                                            <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                                                                <span aria-hidden="true">×</span>
                                                            </button>
                                                        </div>
                                                        <form action="<?php echo site_url() . 'action_his/angkat_karyawan'; ?>" method="post">
                                            ...
                                            <!-- EDIT KARYAWAN Modal-->
                                            <div class="modal fade" id="ModalEditKar<?php echo $u->nik_training ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="<?php echo site_url("action_his/do_edit_karyawan_temp/" . $u->nik_training) ?>" method="post">
                                                            <div class="modal-body">
                                                                <div class="form-row">
                                                                    ...
                                                                    <div class="col-md-6 mb-3">
                                                                            <label><b>NIK</b></label>
                                                                            <input type="text" class="form-control" name="nik_training" value="<?php echo $u->nik_training ?>" required>
