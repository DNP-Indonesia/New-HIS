						...
						<tr>
							...
							<td style="width:15%;">
								<a href="#" class="btn btn-warning btn-icon-split btn-sm" data-toggle="modal"
									data-target="#edit<?php echo $u->id_dep ?>">
								...
								<a href="#" class="btn btn-success btn-icon-split btn-sm" data-toggle="modal"
									data-target="#view<?php echo $u->id_dep ?>">
									<span class="icon text-white-50">
...
<!-- TAMBAH USER Modal-->
<div class="modal fade" id="ModalTbhDept" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
	aria-hidden="true">
...
<!-- EDIT USER Modal-->
<div class="modal fade" id="edit<?php echo $u->id_dep ?>" tabindex="-1" role="dialog"
			...
			<form action="<?php echo site_url() . 'action_his/do_edit_departemen' ?>" method="post">
				...
				<div class="modal-body">
					<div class="form-row">
						...
						<div class="col-md-12 mb-3">
							<label for="exampleInputEmail1"><b>Nama Departemen</b></label>
							<input type="text" class="form-control" id="exampleInputEmail1" name="nama_dep"
								value="<?php echo $u->nama_dep; ?>" required>
							<small id="emailHelp" class="form-text text-muted">Input nama departemen disini</small>
						</div>
					</div>
				</div>
...
<!-- VIEW Modal-->
<div class="modal fade" id="view<?php echo $u->id_dep ?>" tabindex="-1" role="dialog"
	aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLabel">Section Pada Departemen
					<br><strong><?php echo $u->nama_dep ?></strong></h5>
				<button class="close" type="button" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">×</span>
				</button>
			</div>
				...
				<div class="alert alert-primary" role="alert">
					...
					<form action="<?php echo site_url() . 'action_his/do_tbh_section' ?>" method="post">
						...
						<div class="form-row">
							<div class="col-md-12 mb-3">
								<!-- <label for="exampleInputEmail1"><b>Nama Departemen</b></label> -->
								<input type="text" class="form-control" id="exampleInputEmail1" name="nama_section"
									value="" required>
