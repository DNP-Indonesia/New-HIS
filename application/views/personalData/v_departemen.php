...
<?php foreach ($dep as $u) { ?>
    ...
    <div class="modal fade" id="edit<?php echo $u->id_dep ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-l" role="document">
            <div class="modal-content">
                ...
                <form action="<?php echo site_url() . 'Master/c_karyawan/do_edit_departemen' ?>" method="post">
                                ...
                                <select class="form-control" id="exampleFormControlSelect1" name="id_divisi" required>
                                    ...
                                    foreach ($div as $d) { ?>
                                        <option value="<?php echo $d->id_divisi ?>" <?php if ($d->id_divisi == $u->id_divisi) {
                                                                                        echo "selected";
                                                                                    } ?>><?php echo $d->nama_divisi ?></option><?php } ?>
                                </select>
                                <small id="emailHelp" class="form-text text-muted">Pilih nama divisi disini</small>
                            </div>
                            <div class="col-md-12 mb-3">
    ...
    <!-- VIEW Modal-->
    <div class="modal fade" id="view<?php echo $u->id_dep ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <div class="alert alert-primary" role="alert">
                        ...
                        <hr>
                        <form action="<?php echo site_url() . 'Master/c_karyawan/do_tbh_section' ?>" method="post">
                            <input type="text" name="id_dep" value="<?= $u->id_dep ?>" hidden>
                            <div class="form-row">
                                <div class="col-md-12 mb-3">
                                    <!-- <label for="exampleInputEmail1"><b>Nama Departemen</b></label> -->
