						...
						<tr>
							...
							<td style="width:15%;">
								<a href="#" class="btn btn-warning btn-icon-split btn-sm" data-toggle="modal"
									data-target="#edit<?php echo $u->id_divisi ?>">
								...
								<a href="#" class="btn btn-success btn-icon-split btn-sm" data-toggle="modal"
									data-target="#view<?php echo $u->id_divisi ?>">
									<span class="icon text-white-50">
...
<!-- TAMBAH DIVISI Modal-->
<div class="modal fade" id="ModalTbhDiv" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
	aria-hidden="true">
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			...
			<form action="<?php echo site_url() . 'Master/action_his/do_tbh_divisi'; ?>" method="post">
...
<!-- EDIT DIVISI Modal-->
<div class="modal fade" id="edit<?php echo $u->id_divisi ?>" tabindex="-1" role="dialog"
	...
	<div class="modal-dialog modal-dialog-centered modal-xl" role="document">
		<div class="modal-content">
			...
			<form action="<?php echo site_url() . 'Master/action_his/do_edit_divisi' ?>" method="post">
				<input type="text" name="id_divisi" value="<?= $u->id_divisi ?>" hidden>
				<div class="modal-body">
					<div class="form-row">
						<div class="col-md-12 mb-3">
							<label for="exampleInputEmail1"><b>Nama Divisi</b></label>
							<input type="text" class="form-control" id="exampleInputEmail1" name="nama_divisi"
								value="<?php echo $u->nama_divisi; ?>" required>
							<small id="emailHelp" class="form-text text-muted">Input nama divisi disini</small>
						</div>
					</div>
				</div>
...
<!-- VIEW Modal-->
<div class="modal fade" id="view<?php echo $u->id_divisi ?>" tabindex="-1" role="dialog"
	aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLabel">Daftar Departemen Pada Divisi
					<br><strong><?php echo $u->nama_divisi ?></strong></h5>
				<button class="close" type="button" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">×</span>
				</button>
			</div>
					...
					<form action="<?php echo site_url() . 'Master/action_his/do_tbh_departemen' ?>" method="post">
						...
						<div class="form-row">
							<div class="col-md-12 mb-3">
								...
								<input type="text" class="form-control" id="exampleInputEmail1" name="nama_departemen"
									value="" required>
