					...
					<tr>
						<th scope="row">
							<a href="" class="btn btn-warning btn-icon-split btn-sm" data-toggle="modal"
								data-target="#ModalEditKar<?php echo $log->nik ?>">
				...
				<table class="table table-striped" id="dataTable" width="100%" cellspacing="0">
					...
					<tbody>
						...
						<tr>
							...
							<td style="background-color: #de0404; color: #ffffff;">
								<?php echo $h->nama_section_sebelum; ?></td>
							<td><?php echo $h->nama_section_sesudah; ?></td>
							<td style="background-color: #de0404; color: #ffffff;">
								<?php echo $h->nama_golongan_sebelum; ?></td>
							<td><?php echo $h->nama_golongan_sesudah; ?></td>
							<td style="background-color: #de0404; color: #ffffff;">
								<?php echo $h->nama_jabatan_sebelum; ?></td>
							<td><?php echo $h->nama_jabatan_sesudah; ?></td>
							<td style="background-color: #de0404; color: #ffffff;"><?php echo $h->nama_shift_sebelum; ?>
							</td>
...
<!-- EDIT KARYAWAN Modal-->
<div class="modal fade" id="ModalEditKar<?php echo $log->nik ?>" tabindex="-1" role="dialog"
			...
			<form action="<?php echo site_url("Master/action_his/do_edit_karyawan/" . $log->nik) ?>" method="post">
				<div class="modal-body">
					<div class="form-row">
						...
						<div class="col-md-6 mb-3">
							<label><b>NIK</b></label>
							<input type="text" class="form-control" name="nik" value="<?php echo $log->nik; ?>"
								required>
					...
					<div class="form-row">
						...
						<div class="col-md-6 mb-3">
							...
							<select class="form-control" id="exampleFormControlSelect1" name="id_section" required>
								...
								<option value="<?php echo $sec->id_section; ?>" <?php echo $sel; ?>>
					...
					<div class="form-row">
						<div class="col-md-6 mb-3">
							...
							<select class="form-control" id="exampleFormControlSelect1" name="id_golongan" required>
								...
								<?php
                                                                            ...
                                                                            ?>
								<option value="<?php echo $class->id_golongan; ?>" <?php echo $sel; ?>>
						...
						<div class="col-md-6 mb-3">
							...
							<select class="form-control" id="exampleFormControlSelect1" name="id_shift" required>
								...
								<option value="<?php echo $sh->id_shift; ?>" <?php echo $sel; ?>>
						...
						<div class="col-md-6 mb-3">
							...
							<select class="form-control" id="exampleFormControlSelect1" name="id_jabatan" required>
								<?php
                                                                            ...
                                                                            ?>
								<option value="<?php echo $jab->id_jabatan; ?>" <?php echo $sel; ?>>
					...
					<div class="form-row">
						<div class="col-md-6 mb-3">
							...
							<small id="emailHelp" class="form-text text-muted">Tanggal
								Masuk</small>
						</div>
						<div class="col-md-6 mb-3">
