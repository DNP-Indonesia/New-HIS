                			...
                			<div class="table-responsive">
                				<table class="table table-bordered" id='dataTable' width="100%" cellspacing="0">
                					...
                					<tbody>
                									...
                									<div class="dropdown-menu bg-gradient-dark"
                										...
                										<p class="dropdown-item">
                											<a href="" class="btn btn-primary btn-icon-split btn-sm"
                												data-toggle="modal"
                												data-target="#ModalEditKar<?php echo $u->nik ?>">
                												<span class="icon text-white-50">
                										...
                										<p class="dropdown-item">
                											<a href="" class="btn btn-warning btn-icon-split btn-sm"
                												data-toggle="modal"
                												data-target="#Mutasi<?php echo $u->nik ?>">
                												<span class="icon text-white-50">
                													<i class="fas fa-edit"></i>
                												</span>
                										...
                										<p class="dropdown-item">
                											<a href="<?php echo site_url("Master/Page_his/history_karyawan/" . $u->nik) ?>"
                												...
                												<span class="text">Detail Karyawan</span>
                											</a>
                										</p>
                										<p class="dropdown-item">
                											<a href=""
                												...
                												data-toggle="modal"
                												data-target="#ModalOut<?php echo $u->nik ?>">
                												<span class="icon text-white-50">
                						...
                						<!-- KeLUARKAN Modal-->
                						<div class="modal fade" id="ModalOut<?php echo $u->nik ?>" tabindex="-1"
                							role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                							<div class="modal-dialog modal-dialog-centered" role="document">
                								<div class="modal-content">
                									<div class="modal-header">
                										<h3 class="modal-title" id="exampleModalLabel">Keluarkan
                									...
                									<form
                										action="<?php echo site_url() . 'Master/action_his/do_out_karyawan'; ?>"
                										method="post">
                											...
                											<div class="form-row">
                												<div class="col-md-12 mb-3">
                													...
                													<select class="form-control"
                														...
                														<option value="Mengundurkan Diri">Mengundurkan
                															Diri</option>
                													...
                													<small id="emailHelp"
                														class="form-text text-muted">Pilih alasan keluar
                														disini</small>
                												</div>
                											</div>
                										</div>
                						...
                						<!-- EDIT KARYAWAN Modal-->
                						<div class="modal fade" id="ModalEditKar<?php echo $u->nik ?>" tabindex="-1"
                							role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                						...
                						<div class="modal fade" id="Mutasi<?php echo $u->nik ?>" tabindex="-1"
                							role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                							<div class="modal-dialog modal-dialog-centered modal-xl" role="document">
                								<div class="modal-content">
                									<div class="modal-header">
                										<h3 class="modal-title" id="exampleModalLabel">Mutasi Karyawan
                										</h3>
                										<button class="close" type="button" data-dismiss="modal"
                											aria-label="Close">
                											<span aria-hidden="true">×</span>
                										...
                										<div class="modal-body">
                											<div class="form-row">
                												<div class="col-md-6 mb-3">
                													...
                													<input type="text" class="form-control"
                														id="exampleInputEmail1" name="nama"
                														value="<?php echo $u->nama ?>" disabled>
                													<small id="emailHelp"
                				...
                				<div class="modal-body">
                					<div class="form-row">
                						<div class="col-md-6 mb-3">
                							...
                							<small id="emailHelp" class="form-text text-muted">Input spysiid
                								disini</small>
                						</div>
                					</div>
                					<div class="form-row">
