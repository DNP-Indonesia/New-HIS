<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="#" class="d-none d-sm-inline-block btn btn-lg btn-primary shadow-sm" data-toggle="modal"
            data-target="#ModalTbhUser"><i class="fas fa-plus fa-sm text-white-50"></i> Tambah User Baru</a>
    </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="#" class="btn btn-warning btn-icon-split btn-sm" data-toggle="modal"
                                    data-target="#edit<?php echo $u->id_user; ?>">
...
<!-- TAMBAH USER Modal-->
<div class="modal fade" id="ModalTbhUser" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <form action="<?= site_url() . '/action_his/do_tbh_user' ?>" method="post">
                ...
                ?>
                                ...
                                <option value='<?= $kar->spysiid ?>'>
                                    <?= $kar->spysiid . ' - ' . $kar->nama . ' [' . $kar->nik . ']' ?> </option>
...
<!-- EDIT USER Modal-->
<div class="modal fade" id="edit<?= $u->id_user ?>" tabindex="-1" role="dialog"
        ...
        <div class="modal-content">
            ...
            <form action="<?= site_url() . '/action_his/do_edit_user' ?>" method="post">
                ...
                ?>
                                ...
                                <!-- <option value='admin_medical' <?php if ($u->role == 'admin_medical') {
                                    echo 'selected';
                                } ?>> Admin Medical</option>
                <option value='medical_1' <?php if ($u->role == 'medical_1') {
                    echo 'selected';
                } ?>> Medical 1 </option>
                <option value='medical_2' <?php if ($u->role == 'medical_2') {
                    echo 'selected';
                } ?>> Medical 2 </option> -->
                            </select>
                            <small id="emailHelp" class="form-text text-muted">Pilih Role user</small>
...
<!-- HAPUS Modal-->
<div class="modal fade" id="hapus<?= $u->id_user ?>" tabindex="-1" role="dialog"
    aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Yakin ingin menghapus data
                    <br><strong><?= $u->nama ?>?</strong></h5>
                <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
            </div>
            ...
            <div class="modal-footer">
                ...
                <a class="btn btn-danger"
                    href="<?= site_url() ?>action/hapus_byid/user/id_user/<?= $u->id_user ?>">Hapus</a>
            </div>
        </div>
    </div>
</div>
