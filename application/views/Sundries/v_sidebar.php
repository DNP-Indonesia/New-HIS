...
<ul class="navbar-nav bg-success sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <?php if ($this->session->userdata('role') == 'super_user') { ?>
        ...
        <li class="nav-item <?php if (isset($menu) && in_array($menu, ['barang', 'konsumsi', 'kategori'])) {
            echo 'active';
        } ?>">
            ...
            <div id="mastersundriesmenu" class="collapse <?php if (isset($menu) && in_array($menu, ['barang', 'jenis', 'kategori'])) {
                echo 'show';
            } ?>" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <a class="collapse-item <?php if ($menu == 'barang') {
                        echo 'active';
                    } ?>" href="<?php echo site_url('barang'); ?>">
                        Barang
                    </a>
                    <a class="collapse-item <?php if ($menu == 'jenis') {
                        echo 'active';
                    } ?>" href="<?php echo site_url('jenis'); ?>">
                        Jenis
                    </a>
                    <a class="collapse-item <?php if ($menu == 'jenis') {
                        echo 'active';
