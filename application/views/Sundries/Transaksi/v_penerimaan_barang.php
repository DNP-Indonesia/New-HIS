                ...
                <li class="nav-item active">
                    ...
                    <div id="collapse-transaksi" class="collapse show" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a href="<?= base_url('Sundries/Transaksi/c_penerimaan/penerimaanpage') ?>" class="collapse-item text-success">
                                    Penerimaan Barang
                            </a>
                        </div>
                    </div>
                                ...
                                <table class="table table-borderless small tbl">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a onclick="deleteConfirm('<?php echo base_url('Sundries/Transaksi/c_penerimaan/hapuspenerimaan/'.$tempel->id_penerimaan) ?>')"
                                                                href="#" class="btn btn-sm btn-danger">
                                                    Hapus
                                                </a>
                                                <a href="<?php echo base_url(); ?>Sundries/Transaksi/c_penerimaan/detail/<?php echo $tempel->id_penerimaan ?>" class="btn btn-sm btn-purple">
                                                    Lihat Detail   
                                                </a> 
                                                <a href="<?php echo base_url(); ?>Sundries/Transaksi/c_penerimaan/formaddbarang/<?php echo $tempel->id_penerimaan ?>" class="btn btn-sm btn-info">
        ...
        <div class="modal fade" id="modal-penerimaan" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <form method="post" action="<?= base_url('Sundries/Transaksi/c_penerimaan/penerimaanadd') ?>">
            ...
            <div class="modal fade" id="modal-barang<?php echo $tempel->id_penerimaan;?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <form method="post" action="<?= base_url('Sundries/Transaksi/c_penerimaan/adddaftarbarang') ?>">
                            <div class="modal-body">
                                <div class="form-row mb-3">
                                    <div class="col-md-6">
                                        <label>Faktur Purchase</label>
