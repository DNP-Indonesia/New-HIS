...
<body id="page-top">
            ...
            <li class="nav-item active">
                ...
                <div id="collapse-transaksi" class="collapse show" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item text-success" href="<?= base_url('transaksi-sundries/request-sundries') ?>">
                            Request Sundries
                        </a>
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a onclick="deleteConfirm('<?php echo base_url('Sundries/Transaksi/c_persetujuan/requestsundriesdelete/' . $tempel->faktur) ?>')" href="#" class="btn btn-sm btn-danger">
                                                                    Hapus
                                                                </a>
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="<?php echo base_url(); ?>Sundries/Transaksi/c_persetujuan/printpdf/<?php echo $tempel->faktur ?>" target="_blank" class="btn btn-sm btn-success">
                                                                    Cetak PDF
                                                                </a>
                                                                <a href="<?php echo base_url(); ?>Sundries/Transaksi/c_persetujuan/detail/<?php echo $tempel->faktur ?>" class="btn btn-sm btn-purple">
                                                                    Lihat Detail
    ...
    <div class="modal fade" id="modal-tambah" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <form action="<?= base_url('Sundries/Transaksi/c_persetujuan/requestsundriesadd') ?>" method="POST">
        ...
        <div class="modal fade" id="modal-selesai<?php echo $tempel->id_request_sundries; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <form action="<?= base_url('Sundries/Transaksi/c_persetujuan/requestfinish') ?>" method="POST">
                        <div class="modal-body">
                            <div class="form-row">
                                <div class="col-md-6 mb-3">
                                    <label>Faktur</label>
    ...
    <script>
        ...
        function loaddatabarang() {
            ...
            $.ajax({
                type: 'POST',
                url: "<?= site_url('Sundries/Transaksi/c_persetujuan/showbarangkeranjang') ?>",
                data: {
                    id_user: id_user
                },
                cache: false,
        ...
        $("#keranjang").click(function() {
            ...
            if (id_barang == 0) {
                ...
                $.ajax({
                    type: 'POST',
                    url: "<?= site_url('Sundries/Transaksi/c_persetujuan/cekkeranjang') ?>",
                    data: {
                        id_barang: id_barang,
                        qty: qty,
                        id_user: id_user,
        ...
        $(document).ready(function() {
            $('#id_barang').change(function() {
                ...
                $.ajax({
                    type: 'POST',
                    url: "<?= site_url('Sundries/Transaksi/c_persetujuan/tampildetailbarang') ?>",
