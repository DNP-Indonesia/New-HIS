...
<body id="page-top">
            ...
            <li class="nav-item active">
                ...
                <div id="collapse-transaksi" class="collapse show" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="<?= base_url('transaksi-sundries/pembuatan-estimasi') ?>">Pembuatan Estimasi</a>
                        <a class="collapse-item text-success" href="<?= base_url('transaksi-sundries/request-consumption') ?>">Request Consumption</a>
                        ...
                        <a class="collapse-item" href="<?= base_url('transaksi-sundries/request-purchase') ?>">Penerimaan Barang</a>
                    </div>
                </div>
            </li>
            <!-- Divider -->
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php if ($tempel->status == 'Request') { ?>
                                                            <a onclick="deleteConfirm('<?php echo base_url('Sundries/Transaksi/c_konsumsi/consumptiondelete/' . $tempel->faktur) ?>')" href="#" class="btn btn-sm btn-danger">
                                                                Hapus
                                                            </a>
                                                        <?php } ?>

                                                        <a href="<?php echo base_url(); ?>Sundries/Transaksi/c_konsumsi/detail/<?php echo $tempel->faktur ?>" target="_blank" class="btn btn-sm btn-purple">
                                                            Lihat Detail
                                                        </a>
                                                        <?php if ($tempel->status != 'Request') { ?>
                                                            <a href="<?php echo base_url(); ?>Sundries/Transaksi/c_konsumsi/printpdf/<?php echo $tempel->faktur ?>" target="_blank" class="btn btn-sm btn-success">
                                                                Cetak PDF
                                                            </a>
                                                        <?php } ?>
                                                    </td>
    ...
    <div class="modal fade" id="modal-tambah" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
            <div class="modal-content">
                ...
                <form action="<?= base_url('Sundries/Transaksi/c_konsumsi/consumptionadd') ?>" method="POST">
    ...
    <script>
        ...
        function loaddatabarang() {
            ...
            $.ajax({
                type: 'POST',
                url: "<?= site_url('Sundries/Transaksi/c_konsumsi/showkeranjang') ?>",
                data: {
                    id_user: id_user
                },
                cache: false,
        ...
        $("#keranjang").click(function() {
            ...
            if (id_barang == 0) {
                ...
                $.ajax({
                    type: 'POST',
                    url: "<?= site_url('Sundries/Transaksi/c_konsumsi/keranjangadd') ?>",
                    data: {
                        id_barang: id_barang,
                        qty: qty,
                        id_user: id_user,
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#fakturestimasi').change(function() {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?= site_url('Sundries/Transaksi/c_konsumsi/barangbyfaktur') ?>",
                    data: {
                        faktur: faktur
                    },
                    dataType: 'JSON',
