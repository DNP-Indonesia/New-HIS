            ...
            <div class="card-body">
                <nav>
                    <div class="nav nav-tabs mb-3" id="nav-tab" role="tablist">
                        <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#disetujui" role="tab" aria-controls="nav-home" aria-selected="true">
                            Persetujuan
                        </a>
                ...
                <div class="tab-content" id="nav-tabContent">
                    <div class="tab-pane fade show active" id="disetujui" role="tabpanel" aria-labelledby="nav-home-tab">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-row">
                        <div class="col-md-3 mb-3">
                            <label>Faktur</label>
                            <input type="text" class="form-control" value="RS-<?= date('d-m-Y-H-i-s') ?>" name="faktur" required readonly>
                        </div>
                        <div class="col-md-3 mb-3">
                            <label>Tanggal</label>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-row">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control" value="<?= date('Y-m-d') ?>" name="tanggalselesai" required readonly>
                                <input type="text" class="form-control" name="status" required value="Selesai" hidden>
                            </div>
                            <div class="col-md-4 mb-3">
                                <label>Selesai Jam</label>
                                <input type="text" class="form-control" value="" name="jamselesai" required readonly>
                                <input type="text" class="form-control" name="status" required value="Selesai" hidden>
                            </div>
                        </div>
                    </div>
