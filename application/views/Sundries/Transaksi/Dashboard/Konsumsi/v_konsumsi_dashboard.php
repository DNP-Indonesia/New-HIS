...
<div class="container">
    <div class="row">
        <div class="col-sm-4">
            <a href="<?= site_url('admin-bagian-consumption-sundries') ?>" style="text-decoration: none;">
        ...
        <div class="col-sm-4">
            <a href="<?= site_url('kepala-bagian-consumption-sundries') ?>" style="text-decoration: none;">
                <div class="card text-white mb-3">
                    <div class="card-body">
