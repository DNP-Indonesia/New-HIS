    ...
    <body id="page-top">
                                    ...
                                    <table class="table table-borderless small" id="dataTable">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if ($tempel->status =='Diajukan'){?>
                                                            <a onclick="deleteConfirm('<?php echo base_url('Sundries/Transaksi/c_estimasi/estimasidelete/'.$tempel->faktur) ?>')"
                                                                href="#" class="btn btn-sm btn-danger">
                                                                Hapus
                                                            </a>
                                                     <?php } ?>
                                                    
                                                    <a href="<?php echo base_url(); ?>Sundries/Transaksi/c_estimasi/detail/<?php echo $tempel->faktur ?>" target="_blank" class="btn btn-sm btn-purple">
                                                        Lihat Detail
                                                    </a>

                                                    <a href="<?php echo base_url(); ?>Sundries/Transaksi/c_estimasi/printpdf/<?php echo $tempel->faktur ?>" target="_blank" class="btn btn-sm btn-success">
                                                        Cetak PDF
                                                    </a>
                                                </td>
                                            </tr>
        ...
        <div class="modal fade" id="modal-tambah" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
                <div class="modal-content">
                    ...
                    <form action="<?= base_url('Sundries/Transaksi/c_estimasi/estimasiadd') ?>" method="POST">
        ...
        <script>
            ...
            function loaddatabarang(){
                ...
                $.ajax({
                    type:'POST',
                    url: "<?= site_url('Sundries/Transaksi/c_estimasi/showkeranjang')?>",
            ...
            $("#keranjang").click(function(){
                ...
                if (id_barang == 0){
                    ...
                    $.ajax({
                        type:'POST',
                        url:"<?= site_url('Sundries/Transaksi/c_estimasi/keranjangadd')?>",
                        data:{
                            id_barang : id_barang,
                            qty : qty,
                            id_user : id_user,
