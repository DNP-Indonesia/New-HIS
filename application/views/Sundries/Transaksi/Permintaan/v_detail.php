                ...
                <form action="<?php echo site_url('approvepermintaan'); ?>" method="POST">
                    <div class="modal-body">
                        ...
                        <div class="form-row">
                            ...
                            <input type="text" class="form-control" name="status2" required value="Disetujui2"
                                hidden>
                        ...
                        <div class="form-row">
                            <div class="col-md-12 mb-3">
                                <input type="text" class="form-control" name="status" value="Request" required
                                    hidden>
                                <input type="text" class="form-control" name="stkeranjang" value="Tidak"
                                    required hidden>
                            </div>
                        </div>
                    </div>
