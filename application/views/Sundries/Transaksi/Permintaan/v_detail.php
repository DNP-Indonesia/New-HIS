...
<body id="page-top">
    <div class="container-fluid">
        <?php if ($this->session->userdata('role') == 'sdr_Admin Bagian') { ?>
            <a href="<?php echo site_url('permintaan') ?>" class="btn btn-sm btn-purple mt-4 mb-4">Kembali Ke Halaman
                Request Sundries</a>
        <?php } else { ?>
                            ...
                            <div class="form-row">
                                <?php if ($this->session->userdata('role') == 'sdr_Kepala Gudang') { ?>
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" name="penyetuju"
                                            value="<?php echo $tempel->penyetuju1 ?>" readonly>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" name="tgl_setuju" value="<?= date('Y-m-d') ?>"
                                    hidden required>

                                <input type="text" class="form-control" value="<?php date_default_timezone_set('Asia/Jakarta');
                                echo date('H:i') ?>" name="jamsetuju" required hidden>
                            </div>
                        </div>
        ...
        <div class="modal fade" id="modal-tolak<?php echo $tempel->id_request_sundries; ?>" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <form action="<?php echo site_url('Sundries/requestsundriescontroller/requestreject') ?>" method="POST">
                        <div class="modal-body">
                            <div class="form-row">
                                <div class="col-md-4 mb-3">
                                    <label>Faktur</label>
                            ...
                            <div class="form-row">
                                ...
                                <input type="text" class="form-control" name="status" required value="Ditolak" hidden>
                                <input type="text" class="form-control" value="<?php date_default_timezone_set('Asia/Jakarta');
                                echo date('H:i') ?>" name="jam" required hidden>
                                <input type="text" class="form-control" name="id_user"
                                    value="<?php echo $this->session->userdata('id_user') ?>" readonly hidden>
                            </div>
                        </div>
                        <div class="modal-footer">
        ...
        <div class="modal fade" id="modal-edit<?php echo $tempel->id_detail_sundries; ?>" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <form action="<?php echo site_url('Sundries/requestsundriescontroller/jumlahupdate') ?>" method="POST">
                        <div class="modal-body">
                            <div class="form-row">
                                <div class="col-md-6 mb-3">
                                    <label>Faktur</label>
                                    <input class="form-control" type="text" name="faktur"
                                        value="<?php echo $tempel->faktur; ?>" readonly>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label>Barang</label>
                                    <input class="form-control" type="text" name="barang"
                                        value="<?php echo $tempel->id_barang; ?>" hidden>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="catatan"
                                        value="<?php echo $tempel->keterangan; ?>">
                                </div>
                            </div>
                        </div>
                        <div class="modal-footer">
        ...
        <div class="modal fade" id="modal-repeat<?php echo $tempel->id_request_sundries; ?>" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <form action="<?php echo site_url('Sundries/requestsundriescontroller/requestulang') ?>" method="POST">
                        <div class="modal-body">
                            <div class="form-row">
                                <div class="col-md-12 mb-3">
                                    <label>Faktur</label>
