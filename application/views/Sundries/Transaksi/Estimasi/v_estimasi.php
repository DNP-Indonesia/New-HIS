...
<div class="container-fluid">
            ...
            <div class="card-body">
                <nav>
                    <div class="nav nav-tabs mb-3" id="nav-tab" role="tablist">
                        <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#diajukan" role="tab" aria-controls="nav-home" aria-selected="true">
                            Pengajuan
                        </a>
                        ...
                        <a class="nav-item nav-link" id="nav-contact-tab" data-toggle="tab" href="#proses" role="tab" aria-controls="nav-contact" aria-selected="false">
                            Pemerosesan
                        </a>
                        </a>
                        <a class="nav-item nav-link" id="nav-contact-tab" data-toggle="tab" href="#ready" role="tab" aria-controls="nav-contact" aria-selected="false">
                            Barang Ready
                        </a>
    ...
    ?>
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="font-weight-bold text-success">
                    Detail Estimation Making Bagian Anda
                </h6>
            </div>
            <div class="card-body">
                <nav>
                        ...
                        <div class="table-container table-responsive-xl">
                            <table class="table table-borderless small tbl">
                                ...
                                <tbody>
                                    <?php
                                    $no = 1;
                                    foreach ($kabagestimasi as $tempel) {
                                    ?>
                                        <tr>
                                            <td class="text-center">
                                                <?php echo $no; ?>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-row">
                        <div class="col-md-3 mb-3">
                            <label>Faktur</label>
                            <input type="text" class="form-control" value="EM-<?= date('d-m-Y-H-i-s') ?>" name="faktur" required readonly>
                        </div>
                        <div class="col-md-3 mb-3">
                            <label>Tanggal</label>
                        ...
                        <div class="col-md-3 mb-3">
                            <label>Jam</label>
                            <input type="text" class="form-control" value="<?= date('H:i:s') ?>" name="jamdibuat" required readonly>
                        </div>
                        <div class="col-md-3 mb-3">
                    ...
                    <div class="form-row">
                        <div class="col-md-12 mb-3">
                            <label>Catatan</label>
                            <textarea class="form-control" id="catatan" placeholder="Misal, Joyko Erasable Gel Pen | GP-321 Warna Hitam" rows="2"></textarea>
                        </div>
                    </div>
