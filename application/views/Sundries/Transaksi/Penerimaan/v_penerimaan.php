...
<div class="container-fluid">
    ...
    <?php
    if ($this->session->userdata('role') == 'sdr_Admin Gudang' || $this->session->userdata('role') == 'super_user') {
    ?>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a onclick="deleteConfirm('<?php echo base_url('Sundries/penerimaancontroller/hapuspenerimaan/' . $tempel->id_penerimaan); ?>')" href="#" class="btn btn-sm btn-danger">
                                            Hapus
                                        </a>
