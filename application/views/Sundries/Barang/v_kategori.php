...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-success sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="#" data-toggle="collapse" data-target="#collapse-master" aria-expanded="true" aria-controls="collapsePages">
                    <i class="fas fa-fw fa-folder"></i>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a onclick="deleteConfirm('<?php echo base_url('Sundries/Barang/c_kategori/kategoridelete/' . $tempel->id_kategori) ?>')" href="#" class="btn btn-sm btn-danger">
                                                        Hapus
                                                    </a>
                                                    <a href="#" class="btn btn-sm btn-purple" data-toggle="modal" data-target="#modal-jenis<?php echo $tempel->id_kategori ?>">Buat Jenis Barang Baru</a>
                                                </td>
                                            </tr>
                                        <?php
                                            $no++;
    ...
    <div class="modal fade" id="modal-tambah" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form action="<?= base_url('Sundries/Barang/c_kategori/kategoriadd') ?>" method="POST">
                    <div class="modal-body">
                        <div class="form-row">
                            <div class="col-md-12 mb-3">
                                <label>Nama Kategori</label>
                                <input type="text" class="form-control" name="kategori" required placeholder="Masukan Nama Kategori Yang Diinginkan....">
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
    ...
    <?php foreach ($ambil as $tempel) { ?>
        <div class="modal fade" id="modal-edit<?php echo $tempel->id_kategori; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <form action="<?= base_url('Sundries/Barang/c_kategori/kategoriupdate') ?>" method="POST">
                        <div class="modal-body">
                            <div class="form-row">
                                <div class="col-md-12 mb-3">
                                    <label>Nama Kategori</label>
                                    <input type="text" class="form-control" name="kategori" required value="<?php echo $tempel->kategori; ?>">
    ...
    <?php foreach ($ambil as $tempel) { ?>
        <div class="modal fade" id="modal-jenis<?php echo $tempel->id_kategori; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <div class="modal-body">
                            <div class="form-row">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input type="text" name="kategori" value="<?= $tempel->id_kategori ?>" hidden required>
                                </div>
                                <div class="col-md-12">
                                    <label>Untuk Kategori</label>
                                    <input type="text" class="form-control" value="<?= $tempel->kategori ?>" required readonly>
                                </div>
                            </div>
                        </div>
                        <div class="modal-footer">
