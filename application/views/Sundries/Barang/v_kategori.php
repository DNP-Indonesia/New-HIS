            ...
            <ul class="navbar-nav bg-success sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <li class="nav-item active">
                    ...
                    <div id="collapse-master" class="collapse show" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <a class="collapse-item text-success" href="<?= base_url('sundries-master/kategori') ?>">Kategori</a>
                            <a class="collapse-item" href="<?= base_url('sundries-master/jenis') ?>">Jenis</a>
                            <a class="collapse-item" href="<?= base_url('sundries-master/barang')?>">Barang</a>
                        </div>
                    </div>
                </li>
                <li class="nav-item">
