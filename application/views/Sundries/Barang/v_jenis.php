...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-success sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url('Master/Page_his/user') ?>">
            ...
            <li class="nav-item active">
                ...
                <div id="collapse-master" class="collapse show" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item text-success" href="<?= base_url('Sundries/Barang/c_jenis/index') ?>">Jenis</a>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a onclick="deleteConfirm('<?php echo base_url('Sundries/Barang/c_jenis/jenisdelete/' . $tempel->id_jenis) ?>')" href="#" class="btn btn-sm btn-danger">
                                                        Hapus
                                                    </a>
                                                </td>
                                            </tr>
                    ...
                    <div class="modal-body">
                        <div class="form-row">
                            <div class="col-md-12 mb-3">
                                ...
                                <input type="text" class="form-control" name="jenis" required placeholder="Masukan Nama Jenis Yang Diinginkan....">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-md-12 mb-3">
    ...
    <?php foreach ($ambil as $tempel) { ?>
        <div class="modal fade" id="modal-edit<?php echo $tempel->id_jenis; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <form action="<?= base_url('Sundries/Barang/c_jenis/jenisupdate') ?>" method="POST">
                        <div class="modal-body">
                            <div class="form-row">
                                <div class="col-md-12 mb-3">
                                    <label>Nama Jenis</label>
                                    <input type="text" class="form-control" name="jenis" required value="<?php echo $tempel->jenis; ?>">
